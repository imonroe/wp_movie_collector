    ...
    <div class="wp-movie-collector-form">
        <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" id="wp-movie-collector-edit-box-set-form">
            ...
            <div class="form-group">
                ...
                <input type="number" id="box-set-release-year" name="box_set[release_year]" value="<?php echo esc_attr($box_set['release_year']); ?>" min="1900" max="<?php echo esc_attr( date('Y') ); ?>" class="small-text" required>
            </div>
